...
- Follow-up on the work in [PR #1555](https://github.com/apollographql/apollo-server/pull/1555) to also pass the `QueryOptions` to the function resolving the `rootValue`, and allowing it to return a promise.
